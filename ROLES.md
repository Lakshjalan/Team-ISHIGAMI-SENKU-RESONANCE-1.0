...
| **ML & AI** | Matching Engine & LLM Arbitrator Lead | Candidate pair blocking, feature vectors, XGBoost pairwise matcher ($C_{match}$), Gemini API reasoning | 📄 [role_ml_model.md](file:///c:/Users/laksh/Desktop/Resonance/roles/role_ml_model.md) |
